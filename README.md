...
**[Scripts]** We provided the training scripts of different teacher models and released their corresponding pre-trained network parameters under the ```ckpt/teacher``` folder. 
