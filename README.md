...
**[Scripts]** We provided the training scripts of different teacher models, and released the corresponding pre-trained teacher network parameters under the ```ckpt/teacher``` folder. 
